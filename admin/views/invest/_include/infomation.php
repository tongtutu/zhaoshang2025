...
<div class="row">
    <div class="col-lg-9">
                        ...
                        <div class="col-12 table-responsive">
                            <table class="table table-">
                                <tbody>
                                    ...
                                    <tr>
                                        <th>公司全称:</th>
                                        <td><?php echo Html::encode(ProjectFunc::adminHideAll($this->context->admin, $model->company_name)); ?>
                                        </td>
                                    </tr>
                                    <tr>
                                        <th>统一信用代码:</th>
                                        <td><?php echo Html::encode(ProjectFunc::adminHideAll($this->context->admin, $model->usci_code)); ?>
                                        </td>
                                    </tr>
                                    <tr>
                                        <th>客户姓名:</th>
                                        <td><?php echo Html::encode(ProjectFunc::adminHideAll($this->context->admin, $model->contact_name)); ?>
                                        </td>
                                    </tr>
                                    <tr>
                                        <th>联系方式:</th>
                                        <td><?php echo Html::encode(ProjectFunc::adminHideAll($this->context->admin, $model->contact_phone)); ?>
                                        </td>
                                    </tr>
                                    <tr>
                                        <th>联系地址:</th>
                                        <td><?php if ($model->province): ?><?php echo Html::encode($model->province); ?><?php endif; ?><?php if ($model->province): ?>
                                            ...
                                            <?php echo Html::encode(ProjectFunc::adminHideAll($this->context->admin, $model->address)); ?>
                                        </td>
                                    </tr>
                                    <tr>
                                        <th>附件</th>
                                    ...
                                    <tr>
                                        <td colspan="2"> <?php if ($transfers): ?>
                                            <?php foreach ($transfers as $transfer): ?>
                                               <li>
                                                    【<?php echo date('Y-m-d H:i:s', $transfer->time); ?>】   该项目由【<?php echo Html::encode($transfer->operation_name); ?>】从【<span style="color:red;"><?php echo Html::encode($transfer->source_name); ?></span>】过户至【<span style="color:green;"><?php echo Html::encode($transfer->target_name); ?></span>】
                                               </li>
                                            <?php endforeach; ?>
                                            <?php else: ?>
                                                <li>
        ...
        <?php echo $this->render('/_include/maintainList', [
            ...
            'steps' => ProjectConst::STEPS_INVEST,
        ]);
?>
